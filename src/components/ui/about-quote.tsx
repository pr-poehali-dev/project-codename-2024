        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          ...
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Меня зовут <strong>Имя Фамилия</strong> — [ваша должность], кандидат / доктор наук, преподаватель кафедры [название кафедры]. Занимаюсь [научная область] более [N] лет.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Мои научные интересы: [тема 1], [тема 2], [тема 3]. Автор более [N] научных публикаций, участник международных конференций. Открыт к сотрудничеству и научному диалогу.
            </p>
          </div>
        </div>
      </div>
